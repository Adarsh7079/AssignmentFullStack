...
//  deleteUser(id)
  ...
  const handlemodel=(e)=>{
    ...
    setDelete(1);
    console.log("dele mode ",isdelete)
    setModel(0);
    getalldata();
    ...
    <div className="w-screen relative">
      <div>
        <div className=" flex  justify-between p-5">
          ...
          <div>
            <button
              onClick={() => navigate("/dashboardpage/addcategory")}
              ...
              <tbody className=" w-full px-3 ">
                {userData.map((item, id) => (
                  <tr className="bg-gray-100  dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td className=" py-4 ">{item.CategoryName}</td>
            ...
            <div className=" flex flex-col mx-auto mt-10 border-2 border-gray-100 rounded-md w-[400px] h-[200px] bg-white">
              ...
              <div className="flex mx-auto gap-10">
                <button
                 ...
                 className=" border-2 rounded-full px-10 h-[35px] text-gray-500">cancel</button>
                <button
                onClick={(e)=>handlemodel(1)}
                 className=" bg-[#9214b2]  border-2 rounded-full px-10 h-[35px] text-white">confirm</button>
              </div>
            </div>
          </div>
          </div>
